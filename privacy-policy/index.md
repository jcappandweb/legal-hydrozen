...
|---|---|---|
| AdMob data | Display ads | Consent (GDPR Art. 6.1.a) |
| Health Connect data | Core app functionality | Consent (GDPR Art. 9.2.a) |
...
Used to detect and fix crashes, only if you have consented.
